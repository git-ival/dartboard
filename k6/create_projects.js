...
import { getCookies, login, isVersionLT } from "./rancher_utils.js";
...
const customRoleTemplateIds = ["create-ns", "configmaps-manage", "ingress-manage",
  "projectroletemplatebindings-manage", "secrets-manage", "serviceaccounts-manage", "services-manage",
  "persistentvolumeclaims-manage", "workloads-manage", "configmaps-view", "ingress-view", "monitoring-ui-view",
  "projectroletemplatebindings-view", "secrets-view", "serviceaccounts-view",
  "services-view", "persistentvolumeclaims-view", "workloads-view"]
...
export function createProjects(data) {
  ...
  if (enableCatalogRoles) {
    // Ensure we add in these optional roles assuming we are on a Rancher version < 2.11
    customRoleTemplateIds.push("projectcatalogs-view")
    customRoleTemplateIds.push("projectcatalogs-manage")
  }
